        ...
        <div class="px-4">
            <div class="flex items-center justify-between w-full rounded-2xl overflow-hidden bg-white">
                <div class="flex flex-col gap-[2px] px-[30px] pr-4">
                    <h3 class="font-bold text-[22px] leading-[33px]">{{ $category->category_name }}</h3>
                    <p class="text-[#878785]">{{ $category->products()->count() }} Products</p>
                </div>
                <div class="flex shrink-0 w-[140px] h-[120px] overflow-hidden">
                    <img src="{{ asset('storage/' . $category->icon) }}" class="w-full h-full object-cover object-left"
                        alt="thumbnail">
                </div>
            </div>
        </div>
                        ...
                        <div
                            ...
                            <div class="flex w-full items-center justify-between gap-[14px]">
                                <div class="flex flex-col gap-[6px]">
                                    ...
                                    <p class="text-sm leading-[21px] text-[#878785]">{{ $category->category_name }}</p>
                                </div>
