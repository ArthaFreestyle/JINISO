        ...
        <div class="flex flex-col rounded-[20px] p-4 mx-4 pb-5 gap-5 bg-white">
            <div id="info" class="flex items-center justify-between">
                <div class="flex flex-col">
                    <h1 id="title" class="font-bold text-[22px] leading-[30px]">{{ $product->product_name }}</h1>
                    <p class="font-semibold text-lg leading-[27px]">Rp {{ number_format($product->price,0,',','.') }} • {{ $orderData['product_size'] }}</p>
                </div>
                <div class="flex items-center gap-1 me-20">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex items-center w-full rounded-full ring-1 ring-[#090917] px-[14px] gap-[10px] overflow-hidden transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FFC700]">
                    ...
                    <input type="text" name="name" id="name" value="{{ $name }}" class="appearance-none outline-none w-full font-semibold placeholder:font-normal placeholder:text-[#878785] py-[14px]" placeholder="Type your complete name" disabled>
                </div>
            </div>
            <div class="flex flex-col gap-2">
                ...
                <div class="flex items-center w-full rounded-full ring-1 ring-[#090917] px-[14px] gap-[10px] overflow-hidden transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FFC700]">
                    ...
                    <input type="text" name="email" value="{{ $email }}" id="email" class="appearance-none outline-none w-full font-semibold placeholder:font-normal placeholder:text-[#878785] py-[14px]" placeholder="Type your email address" disabled>
                </div>
            </div>
            <hr class="border-[#EAEAED]">
            <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex items-center w-full rounded-full ring-1 ring-[#090917] px-[14px] gap-[10px] overflow-hidden transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FFC700]">
                    ...
                    <input type="text" name="promo" id="promo" wire:model.live.debounce.500ms="promoCode" class="appearance-none outline-none w-full font-semibold placeholder:font-normal placeholder:text-[#878785] py-[14px]" placeholder="Input the promo code">
                </div>
