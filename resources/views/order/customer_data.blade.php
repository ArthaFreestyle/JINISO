        ...
        <div class="relative flex flex-col w-full max-w-[640px] min-h-screen gap-5 mx-auto bg-[#F5F5F0]">
            ...
            <div class="flex items-center rounded-3xl gap-[14px] p-[10px_16px_16px_10px] bg-white mx-4">
                ...
                <div class="flex flex-col w-full">
                    <h1 id="title" class="font-bold text-lg leading-6">{{ $product->product_name }}</h1>
                    <p class="font-semibold text-sm leading-[21px]">{{ $oderData['product_size'] }} • {{ $oderData['quantity'] }} Pcs</p>
                </div>
                    ...
                    <div class="fixed bottom-5 w-full max-w-[640px] z-30 px-4">
                        <div class="flex items-center justify-between rounded-full bg-[#2A2A2A] p-[10px] pl-6">
                            <div class="flex flex-col gap-[2px]">
                                <p id="grand-total" class="font-bold text-[20px] leading-[30px] text-white">Rp {{ number_format($oderData['grand_total_amount'],0,',','.') }}</p>
